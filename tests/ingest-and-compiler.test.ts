...
test('ingest preserves structured compressed tool result payloads and infers risk from metadata even with neutral text', async () => {
    ...
    records: [
      {
        ...
        metadata: {
          ...
          toolAffectedPaths: ['packages/runtime-core/src/runtime/context-compiler.ts', 'tests/context-compiler.test.ts'],
  ...
  assert.deepEqual(riskToolResult.affectedPaths, ['packages/runtime-core/src/runtime/context-compiler.ts', 'tests/context-compiler.test.ts']);
  assert.equal(
