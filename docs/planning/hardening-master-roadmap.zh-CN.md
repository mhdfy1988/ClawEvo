...
相关文档：
- 上下文处理专项：[context-processing-hardening-todo.zh-CN.md](/d:/C_Project/openclaw_compact_context/docs/context-processing/context-processing-hardening-todo.zh-CN.md)
- 其他专项攻坚：[other-hardening-todo.zh-CN.md](/d:/C_Project/openclaw_compact_context/docs/planning/other-hardening-todo.zh-CN.md)
- 其他专项能力边界：[other-hardening-capability-boundary.zh-CN.md](/d:/C_Project/openclaw_compact_context/docs/planning/other-hardening-capability-boundary.zh-CN.md)
- 项目阶段路线图：[context-roadmap.zh-CN.md](/d:/C_Project/openclaw_compact_context/docs/planning/context-roadmap.zh-CN.md)
...
## 推荐执行顺序
### 第一段：上下文处理底座收口
对应 [context-processing-hardening-todo.zh-CN.md](/d:/C_Project/openclaw_compact_context/docs/context-processing/context-processing-hardening-todo.zh-CN.md)
...
### 第二段：长期记忆与召回治理深化
对应 [other-hardening-todo.zh-CN.md](/d:/C_Project/openclaw_compact_context/docs/planning/other-hardening-todo.zh-CN.md)
