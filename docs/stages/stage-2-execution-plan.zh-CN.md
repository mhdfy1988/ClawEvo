...
这份文档把 [context-roadmap.zh-CN.md](/d:/C_Project/openclaw_compact_context/docs/planning/context-roadmap.zh-CN.md) 里的“阶段 2”单独展开成一份可执行计划。
...
- 阶段 2 当前已经完成收口；最新结论与验收结果请同时参考：
  - [stage-2-status.zh-CN.md](/d:/C_Project/openclaw_compact_context/docs/stages/stage-2-status.zh-CN.md)
...
- 当前文档产物： [tool-result-policy.zh-CN.md](/d:/C_Project/openclaw_compact_context/docs/architecture/tool-result-policy.zh-CN.md)
- 一组分类规则：
  - 可安全截断
  - 需保留错误上下文
  - 需保留关键信号
