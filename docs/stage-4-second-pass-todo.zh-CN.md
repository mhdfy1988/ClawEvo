...
- [ ] 当前无剩余待办；后续请转到 [stage-5-todo.zh-CN.md](/d:/C_Project/openclaw_compact_context/docs/stage-5-todo.zh-CN.md)。

## 进行中

- [ ] 当前无进行中任务；后续请转到 [stage-5-todo.zh-CN.md](/d:/C_Project/openclaw_compact_context/docs/stage-5-todo.zh-CN.md)。
...
- [x] TODO 2: 落 Utterance Parser / Clause Splitter ~4d #后端 #上下文 @Codex 2026-03-14
  ...
  - [x] 新增测试：
    - [utterance-parser.test.ts](/d:/C_Project/openclaw_compact_context/src/tests/utterance-parser.test.ts)
