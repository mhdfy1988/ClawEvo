...
1. 先根据 [stage-4-prework.zh-CN.md](/d:/C_Project/openclaw_compact_context/docs/stage-4-prework.zh-CN.md) 收敛阶段 4 范围
2. 再新起阶段 4 TODO
...
对应执行清单见：
[stage-3-todo.zh-CN.md](/d:/C_Project/openclaw_compact_context/docs/stage-3-todo.zh-CN.md)
