...
这份文档对应 [stage-2-execution-plan.zh-CN.md](/d:/C_Project/openclaw_compact_context/docs/stage-2-execution-plan.zh-CN.md) 里的“迭代 2.1：定义源头治理规则”。
...
- [openclaw-hook-findings.zh-CN.md](/d:/C_Project/openclaw_compact_context/docs/openclaw-hook-findings.zh-CN.md)
