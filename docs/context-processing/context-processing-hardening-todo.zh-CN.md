...
相关文档：
- [代码流转图](/d:/C_Project/openclaw_compact_context/docs/context-processing/context-processing-code-flow.zh-CN.md)
- [处理契约](/d:/C_Project/openclaw_compact_context/docs/context-processing/context-processing-contracts.zh-CN.md)
- [summarize 借鉴](/d:/C_Project/openclaw_compact_context/docs/references/summarize-reference-for-context-processing.zh-CN.md)
- [试错学习方案](/d:/C_Project/openclaw_compact_context/docs/knowledge/experience-learning-plan.zh-CN.md)
- [总攻坚路线图](/d:/C_Project/openclaw_compact_context/docs/planning/hardening-master-roadmap.zh-CN.md)

## 待办
- [ ] 当前没有剩余待办；建议下一步转入 [other-hardening-todo.zh-CN.md](/d:/C_Project/openclaw_compact_context/docs/planning/other-hardening-todo.zh-CN.md) 或新的上下文处理深化议题。
...
- [x] TODO 1: 落独立的 `ContextProcessingPipeline` 总入口 ~5d #后端 #架构 @Codex 2026-03-14
  - [x] 新增 [context-processing-pipeline.ts](/d:/C_Project/openclaw_compact_context/packages/runtime-core/src/context-processing/context-processing-pipeline.ts)
...
- [x] TODO 2: 落噪音治理与无意义语句策略 ~4d #后端 #上下文 @Codex 2026-03-15
  - [x] 新增 [noise-policy.ts](/d:/C_Project/openclaw_compact_context/packages/runtime-core/src/context-processing/noise-policy.ts)
...
- [x] TODO 3: 落 `Summary Planner` 与结构化总结候选层 ~4d #后端 #总结 @Codex 2026-03-16
  - [x] 新增 [summary-planner.ts](/d:/C_Project/openclaw_compact_context/packages/runtime-core/src/context-processing/summary-planner.ts)
...
- [x] TODO 4: 拆出 `Semantic Classifier` 与 `Node Materializer` ~5d #后端 #架构 @Codex 2026-03-18
  - [x] 新增 [semantic-classifier.ts](/d:/C_Project/openclaw_compact_context/packages/runtime-core/src/context-processing/semantic-classifier.ts)
  - [x] 新增 [semantic-node-materializer.ts](/d:/C_Project/openclaw_compact_context/packages/runtime-core/src/context-processing/semantic-node-materializer.ts)
...
- [x] TODO 6: 落 `Attempt / Episode` 的 raw-first builder ~5d #后端 #学习 @Codex 2026-03-20
  - [x] 增强 [context-processing-experience.ts](/d:/C_Project/openclaw_compact_context/packages/runtime-core/src/context-processing/context-processing-experience.ts)
...
- [x] TODO 7: 落版本化与缓存策略 ~4d #后端 #性能 @Codex 2026-03-21
  - [x] 新增 [context-processing-versions.ts](/d:/C_Project/openclaw_compact_context/packages/runtime-core/src/context-processing/context-processing-versions.ts)
...
- [x] TODO 8: 接人工校正到上下文处理主链 ~4d #后端 #治理 @Codex 2026-03-22
  - [x] 新增 [context-processing-corrections.ts](/d:/C_Project/openclaw_compact_context/packages/runtime-core/src/context-processing/context-processing-corrections.ts)
