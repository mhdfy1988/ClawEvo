...
import type { SkillCandidate, SkillCandidateLifecycle } from '@openclaw-compact-context/contracts';
import type { SkillCandidateResult, SkillMiningRequest } from '@openclaw-compact-context/contracts';
