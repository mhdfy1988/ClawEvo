import type { GraphNode, JsonObject } from '@openclaw-compact-context/contracts';
import type {
...
import type { RawContextRecord, RawContextSourceType } from '@openclaw-compact-context/contracts';
